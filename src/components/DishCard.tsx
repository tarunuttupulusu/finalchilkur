...
export const DishCard: React.FC<DishCardProps> = ({ dish, onOrderClick }) => {
  ...
  return (
    <motion.div
      ...
      className={`group relative bg-[#F7E7CE] rounded-2xl overflow-hidden border border-brand-dark/10 shadow-sm transition-shadow flex flex-col h-full ${
    ...
    >
      ...
      <div className="absolute top-4 left-4 z-20 flex flex-col gap-2">
        {dish.isPopular && !dish.isOutOfStock && (
          <span className="flex items-center space-x-1 bg-brand-accent text-[#F7E7CE] text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full shadow-md">
